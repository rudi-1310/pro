    ...
    return (
        <footer className='max-container '>
            <div className='flex justify-between items-start gap-20 flex-wrap max-lg:flex-col'>
                <div className='flex flex-col items-start text-white text-4xl'>
                    ...
                    <p className='mt-6 text-base leading-7 font-montserrat text-white sm:max-w-sm '>
                        Empowering memorable events within your budget. Your event dreams, made affordable and extraordinary.
                    </p>
            ...
            <div className='flex justify-between text-white-400 mt-24 max-sm:flex-col max-sm:items-center'>
                <div className='flex flex-1 justify-start items-center gap-2 font-sans cursor-pointer'>
                    <img
                        src={copyrightSign}
                        alt='copyright sign'
                        width={20}
                ...
                <p className=' text-white font-sans cursor-pointer'>Terms & Conditions</p>
            </div>
        </footer>
    );
};
